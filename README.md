# ABC/XYZ + Time-Series Forecasting for Retail Inventory Optimization
...
## Results (Highlights)
- **Profit concentration:** **Around 3%** of SKUs account for **Around 50%** of profit; **Around 6%** for **Around 80%** creating the **super-Pareto** effect.
- **Variability mix:** ~**46% X**, **10% Y**, **44% Z** (stable vs. volatile split is bimodal).
- **Seasonality:**  
...
- **Inference:**
  ...
  - **Further analysis:**
    - Use **seasonal ARIMA/ETS** for X and Y.  
    - Use **non-seasonal / intermittent (e.g., Croston-type, SBA)** or **probabilistic** approaches for Z.
